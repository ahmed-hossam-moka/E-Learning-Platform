...
namespace OnlineLearningPlatform.DAL.Migrations
{
    ...
    [Migration("20250422000853_SetCategoryIdToNullOnDelete")]
    partial class SetCategoryIdToNullOnDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.Instructor", b =>
                {
                    b.HasOne("OnlineLearningPlatform.DAL.Models.User", "User")
                        .WithOne("Instructor")
                        .HasForeignKey("OnlineLearningPlatform.DAL.Models.Instructor", "InstructorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.Student", b =>
                {
                    b.HasOne("OnlineLearningPlatform.DAL.Models.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("OnlineLearningPlatform.DAL.Models.Student", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
