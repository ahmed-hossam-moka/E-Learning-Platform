...
namespace OnlineLearningPlatform.DAL.Migrations
{
    ...
    [Migration("20250510063137_QuizLastVersion1")]
    partial class QuizLastVersion1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.AnswerChoice", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.StudentAnswer", b =>
                {
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.AnswerChoice", b =>
                {
                    b.HasOne("OnlineLearningPlatform.DAL.Models.Question", "Question")
                        .WithMany("Choices")
            ...
            modelBuilder.Entity("OnlineLearningPlatform.DAL.Models.StudentAnswer", b =>
                {
                    ...
                    b.HasOne("OnlineLearningPlatform.DAL.Models.QuizResult", "QuizResult")
                        .WithMany("Answers")
                        .HasForeignKey("QuizResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineLearningPlatform.DAL.Models.AnswerChoice", "SelectedAnswer")
                        .WithMany()
